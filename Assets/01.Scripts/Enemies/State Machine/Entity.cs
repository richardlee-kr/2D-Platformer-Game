...
public class Entity : MonoBehaviour
{
    ...
    public virtual void Update()
    {
        ...
        //Debug.Log("wall: " + CheckWall() + " ledged: " + CheckLedge() + " ground: " + CheckGround() + " state: " + stateMachine.currentState);
    }
    ...
    public virtual bool CheckBottomWall()
    {
        return Physics2D.Raycast(bottomWallCheck.position, aliveGO.transform.right, entityData.wallCheckDistance, entityData.groundLayer);
    }
